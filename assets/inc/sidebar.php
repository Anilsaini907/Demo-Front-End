 ...
 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="http://localhost/AdminLTE_PHP/dashboard.php" class="brand-link">
      <img src="/AdminLTE_PHP/assets/img/amdoc.jpg" alt="Amdocs Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <!--<div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/AdminLTE_PHP/assets/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul id="myList" class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               with font-awesome or any other icon font library -->
            <li class="nav-item">
            <a href="http://localhost/AdminLTE_PHP/dashboard.php" class="nav-link">
          ...
          <li id="userManagement" class="nav-item">
            <a href="http://localhost/AdminLTE_PHP/pages/manageuser.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="http://localhost/AdminLTE_PHP/pages/profile.php" class="nav-link">
